...
// 额外附加的字符串
static char *EXTRA_SIGNATURE = "TEST";
// 校验签名
static int is_verify = 0;
static char *PACKAGE_NAME = "com.demo.md5";
...
Java_com_demo_md5_SignatureUtils_signatureParams(JNIEnv *env, jclass clazz, jstring params_) {
    if (is_verify == 0) {
...
Java_com_demo_md5_SignatureUtils_signatureVerify(JNIEnv *env, jclass clazz, jobject context) {
    // 1. 获取包名
