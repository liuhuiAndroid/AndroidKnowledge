...
public class MusicRender implements GLSurfaceView.Renderer {
    ...
    private void initRenderYUV() {
        String vertexSource = MusicShaderUtil.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = MusicShaderUtil.readRawTxt(context, R.raw.fragment_shader);
        program_yuv = MusicShaderUtil.createProgram(vertexSource, fragmentSource);
